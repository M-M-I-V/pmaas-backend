 ...
 * Mirrors the validation strategy in MedicalVisitRequest.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class DentalVisitRequest {
    ...
    @Size(max = 20, message = "Blood pressure must be 20 characters or fewer")
    ...
    @Size(max = 500, message = "Tooth status must be 500 characters or fewer")
